...
function NavSearch() {
    return (
        <div className="invisible w-[450px] h-[60px] absolute right-0 top-[100px] flex items-center justify-center backdrop-blur-sm">
            <div className=' absolute top-[-60px] right-[30px] visible'><MagnifyingGlassIcon className="h-5 w-5 stroke-[2px] cursor-pointer" aria-hidden="true" /></div>
