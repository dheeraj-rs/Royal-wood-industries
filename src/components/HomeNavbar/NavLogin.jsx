    ...
    return (
        <div className=" w-[25%] h-[100%]">
            <ul className=" w-full h-full flex gap-5 items-center text-[13px] tracking-[.5px] font-semibold pl-10">
                ...
                <li className=' flex items-center'><Link to='/login'><button type='submit' className="flex w-full justify-center leading-5 gap-1"><UserIcon className="h-5 w-5" />LOGIN</button></Link></li>
            </ul>
        </div>
    )
}
